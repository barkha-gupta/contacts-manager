...
const Contacts = ({searchTerm}) => {
  ...
  const uploadData = async () => {
    const dataFile = await fetch("https://contacts-manager-backend-app.herokuapp.com/contact/mycontacts", {
      method: "GET",
      headers: {
...
const handleDeleteAll = async() => {
  ...
  const data = await fetch("https://contacts-manager-backend-app.herokuapp.com/contact/deleteall", {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
      authorization: `test ${localStorage.getItem("token")}`,
